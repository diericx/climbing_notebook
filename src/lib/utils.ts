...
export const muscles: readonly [string, ...string[]] = ['adductor magnus', 'anterior deltoids', 'biceps brachii', 'biceps femoris', 'brachialis', 'gluteus maximus', 'gluteus medius', 'gluteus minimus', 'infraspinatus', 'latissimus dorsi', 'obliques', 'pectoralis major', 'posterior deltoids', 'quadriceps femoris', 'rectus abdominis', 'rhomboids', 'soleus', 'teres major', 'triceps brachii', 'brachioradialis', 'erector spinae', 'gastrocnemius', 'lower trapezius', 'medial deltoids', 'serratus anterior', 'subscapularis', 'tibialis anterior', 'upper trapezius'];
...
export const equipment: readonly [string, ...string[]] = ['ab wheel', 'barbell', 'battle ropes', 'bodyweight', 'cable', 'dumbbell', 'ez bar', 'gymnastic rings', 'kettlebell', 'landmine', 'medicine ball', 'miniband', 'parallette bars', 'resistance band', 'slam ball', 'sliders', 'stability ball', 'superband', 'suspension trainer', 'weight plate'];
export const posture: readonly [string, ...string[]] = ['90/90 seated', 'bent over standing', 'bridge', 'half knee hover', 'half kneeling', 'hanging', 'inverted', 'knee hover quadruped', 'knee over toes split stance standing', 'kneeling', 'l sit', 'march', 'prone', 'quadruped', 'seated', 'seated floor', 'shin box seated', 'side lying', 'side plank', 'single leg bridge', 'single leg standing', 'single leg standing bent knee', 'single leg supported', 'split stance standing', 'staggered stance standing', 'standing', 'supine', 'tall kneeling', 'toe balance standing', 'v sit seated', 'walking', 'wall sit'];
